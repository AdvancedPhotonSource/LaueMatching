#!/usr/bin/env python3
"""Entry point for RunImage.

The implementation moved to ``laue_index/pipeline/RunImage.py`` so that
...
keeps ``python scripts/RunImage.py ...`` and the shell pipeline working from a
checkout, unchanged.
"""
import sys
...
if __name__ == "__main__":
    run_module("RunImage", sys.argv[1:])

#!/usr/bin/env python3
"""Entry point for laue_orchestrator.

The implementation moved to ``laue_index/pipeline/laue_orchestrator.py`` so that
...
keeps ``python scripts/laue_orchestrator.py ...`` and the shell pipeline working from a
checkout, unchanged.
"""
import sys
...
if __name__ == "__main__":
    run_module("laue_orchestrator", sys.argv[1:])

#!/usr/bin/env python3
"""Entry point for annotate_orientation_db.

The implementation moved to ``laue_index/pipeline/annotate_orientation_db.py`` so that
...
keeps ``python scripts/annotate_orientation_db.py ...`` and the shell pipeline working from a
checkout, unchanged.
"""
import sys
...
if __name__ == "__main__":
    run_module("annotate_orientation_db", sys.argv[1:])

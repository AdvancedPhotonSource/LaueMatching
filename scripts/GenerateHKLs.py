#!/usr/bin/env python3
"""Entry point for GenerateHKLs.

The implementation moved to ``laue_index/pipeline/GenerateHKLs.py`` so that
...
keeps ``python scripts/GenerateHKLs.py ...`` and the shell pipeline working from a
checkout, unchanged.
"""
import sys
...
if __name__ == "__main__":
    run_module("GenerateHKLs", sys.argv[1:])

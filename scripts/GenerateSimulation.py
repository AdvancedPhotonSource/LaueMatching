#!/usr/bin/env python3
"""Entry point for GenerateSimulation.

The implementation moved to ``laue_index/pipeline/GenerateSimulation.py`` so that
...
keeps ``python scripts/GenerateSimulation.py ...`` and the shell pipeline working from a
checkout, unchanged.
"""
import sys
...
if __name__ == "__main__":
    run_module("GenerateSimulation", sys.argv[1:])

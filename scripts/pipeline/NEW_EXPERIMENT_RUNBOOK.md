...
```
Experiment folder: <ABSOLUTE PATH>          # e.g. /net/hpcs34/data34c/Run2026-X/<PI>_<YYYYMM>/
...
> core are general. Several analysis scripts still carry hard-coded Ti-6Al-4V lattice constants
...
the Ti-6Al-4V campaign, and its current state).
...
- [ ] Material port (§6) done, or explicitly not needed because the material is Ti-6Al-4V

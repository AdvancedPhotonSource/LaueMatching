#!/usr/bin/env python3
"""Entry point for ImageCleanup.

The implementation moved to ``laue_index/pipeline/ImageCleanup.py`` so that
...
keeps ``python scripts/ImageCleanup.py ...`` and the shell pipeline working from a
checkout, unchanged.
"""
import sys
...
if __name__ == "__main__":
    run_module("ImageCleanup", sys.argv[1:])

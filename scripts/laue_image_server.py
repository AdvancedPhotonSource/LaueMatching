#!/usr/bin/env python3
"""Entry point for laue_image_server.

The implementation moved to ``laue_index/pipeline/laue_image_server.py`` so that
...
keeps ``python scripts/laue_image_server.py ...`` and the shell pipeline working from a
checkout, unchanged.
"""
import sys
...
if __name__ == "__main__":
    run_module("laue_image_server", sys.argv[1:])

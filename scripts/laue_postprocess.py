#!/usr/bin/env python3
"""Entry point for laue_postprocess.

The implementation moved to ``laue_index/pipeline/laue_postprocess.py`` so that
...
keeps ``python scripts/laue_postprocess.py ...`` and the shell pipeline working from a
checkout, unchanged.
"""
import sys
...
if __name__ == "__main__":
    run_module("laue_postprocess", sys.argv[1:])
